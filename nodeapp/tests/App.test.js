    ...
    const mockBooks = [
      {
        ...
        stockQuantity: 10,
        category: 'Fiction',
        coverImage: 'https://8080-eeebbcdcdac333088014defeaefeone.premiumproject.examly.io/images/gatsby.jpg'
      },
      {
        _id: '2',
        ...
        stockQuantity: 5,
        category: 'Science',
        coverImage: 'https://8080-eeebbcdcdac333088014defeaefeone.premiumproject.examly.io/images/history.jpg'
      }
    ];
  ...
  test('Week5_Day4_Should_Add_Book_Successfully', async () => {
    const req = {
      body: {
        ...
        stockQuantity: 8,
        category: 'Fantasy',
        coverImage: 'https://8080-eeebbcdcdac333088014defeaefeone.premiumproject.examly.io/images/harry.jpg'
      }
    };
    const res = {
      json: jest.fn(),
